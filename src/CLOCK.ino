...
void loop(){
  ...
  parseMqtt();
  // Serial.print("The price is");
  // Serial.println(globalData.price);
  
  if(millis() - weaterTime > 300000){ //5分钟更新一次天气
    weaterTime = millis();
    getCityWeater();
  }
  Serial.print(globalData.price);
  scrollText[6] = "CKB:" + globalData.price;
  scrollBanner();
  imgAnim();
}
...
void weaterData(String *cityDZ,String *dataSK,String *dataFC){
  ...
  scrollText[6] = globalData.price;
  
  Serial.println(scrollText[6]);
